...
public class ScrollingWorld extends World
{
    ...
    public ArrayList<IPokemon> party;
    public IPokemon player;

    private KeyReader keys = new KeyReader();
    /**
     * the constructor passes through the initial position of the map
     */
    public ScrollingWorld(ArrayList<Integer> beatenTrainers, int x, int y, ArrayList<HashMap<String, Integer>> bag, ArrayList<IPokemon> party)
    {
